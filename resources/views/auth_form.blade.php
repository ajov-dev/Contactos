            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        <form action="{{ route($action) }}" method="POST" class="bg-dark card card-body"
                            style="width: 23rem;">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <h3 class="fw-normal mb-3 pb-3 text-light" style="letter-spacing: 1px;">
                                        {{ $title }}</h3>
                                </div>
                            </div>
                            ...
                            <div class="pt-1 mb-4">
                                <button class="btn btn-outline-light btn-rounded" type="submit" class="btn btn-primary"
